...
require (
	...
	github.com/agentgateway/agentgateway v0.11.0-alpha.1.0.20251218160022-f0552ee66d6d
...
require (
	...
	github.com/golangci/golangci-lint/v2 v2.6.3-0.20251124203043-9a9fd5b1d9fd // indirect
