...
var TypedNamespacedNameIndexCollectionFunc = krt.WithIndexCollectionFromString(func(s string) utils.TypedNamespacedName {
...
func AgwPolicyCollection(agwPlugins plugins.AgwPlugin, ancestors krt.Collection[*utils.AncestorBackend], krtopts krtutil.KrtOptions) (krt.Collection[ir.AgwResource], PolicyStatusCollections) {
	...
	ancestorCollection := ancestorsIndex.AsCollection(append(krtopts.ToOptions("AncestorBackend"), TypedNamespacedNameIndexCollectionFunc)...)
