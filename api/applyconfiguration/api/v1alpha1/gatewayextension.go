...
func (b *GatewayExtensionApplyConfiguration) GetKind() *string {
	return b.TypeMetaApplyConfiguration.Kind
}

// GetAPIVersion retrieves the value of the APIVersion field in the declarative configuration.
func (b *GatewayExtensionApplyConfiguration) GetAPIVersion() *string {
...
func (b *GatewayExtensionApplyConfiguration) GetNamespace() *string {
	b.ensureObjectMetaApplyConfigurationExists()
